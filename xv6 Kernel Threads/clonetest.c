...
void func(void *arg)
{
  ...
  printf(1, "\tChild thread: dereferenced function's arg to %d\n", *(int*) arg);
  *(int*) arg += 10;
  printf(1, "\tChild thread: incremented arg's value by 10. arg is now %d\n", *(int*) arg);
  sharedVal += 10;
  printf(1, "\tChild thread: incremented sharedVal by 10. sharedVal is now %d\n", sharedVal);
  exit();
