    ...
    1007:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    1017:	52                   	push   %edx
    1018:	52                   	push   %edx
    1019:	68 80 17 00 00       	push   $0x1780
    101e:	6a 02                	push   $0x2
    1020:	e8 6b 05 00 00       	call   1590 <printf>
    exit();
    1025:	e8 14 04 00 00       	call   143e <exit>
  }
  if(link(argv[1], argv[2]) < 0)
    ...
    1032:	e8 67 04 00 00       	call   149e <link>
    1037:	83 c4 10             	add    $0x10,%esp
    103a:	85 c0                	test   %eax,%eax
    103c:	78 05                	js     1043 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
    103e:	e8 fb 03 00 00       	call   143e <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
    1043:	ff 73 08             	pushl  0x8(%ebx)
    1046:	ff 73 04             	pushl  0x4(%ebx)
    1049:	68 93 17 00 00       	push   $0x1793
    104e:	6a 02                	push   $0x2
    1050:	e8 3b 05 00 00       	call   1590 <printf>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12b1:	a1 58 1a 00 00       	mov    0x1a58,%eax
{
  ...
  freep = p;
    12ef:	a3 58 1a 00 00       	mov    %eax,0x1a58
}
    12f4:	5b                   	pop    %ebx
    12f5:	5e                   	pop    %esi
    12f6:	5f                   	pop    %edi
    ...
    1306:	72 ce                	jb     12d6 <free+0x26>
{
  ...
  freep = p;
    132a:	a3 58 1a 00 00       	mov    %eax,0x1a58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    134c:	8b 15 58 1a 00 00    	mov    0x1a58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1391:	39 05 58 1a 00 00    	cmp    %eax,0x1a58
  ...
  return freep;
    13bb:	8b 15 58 1a 00 00    	mov    0x1a58,%edx
    ...
    13e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    13e7:	89 15 58 1a 00 00    	mov    %edx,0x1a58
}
    ...
    base.s.ptr = freep = prevp = &base;
    1400:	c7 05 58 1a 00 00 5c 	movl   $0x1a5c,0x1a58
    1407:	1a 00 00 
    140a:	c7 05 5c 1a 00 00 5c 	movl   $0x1a5c,0x1a5c
    1411:	1a 00 00 
    base.s.size = 0;
    1414:	b8 5c 1a 00 00       	mov    $0x1a5c,%eax
    1419:	c7 05 60 1a 00 00 00 	movl   $0x0,0x1a60
    1420:	00 00 00 
    ...
    14f9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    1527:	f7 f1                	div    %ecx
    1529:	0f b6 92 b0 17 00 00 	movzbl 0x17b0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    176e:	e9 6c fe ff ff       	jmp    15df <printf+0x4f>
          s = "(null)";
    1773:	bb a7 17 00 00       	mov    $0x17a7,%ebx
        while(*s != 0){
